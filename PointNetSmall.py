...
#  Classification: 1024 --> (512,256,classes)
#
# "PointNetSmall.py" :
#  Tnet1:             3 --> (64,128,256) + (256,128,3x3) --> 3 
#  Shared MLP:        3 --> (64,64)
#  Tnet2:            64 --> (64,128,256) + (256,128,64x64) --> 64 
#  After Tnets:      64 --> (64,128,256)
#  Classification: 1024 --> (128,64,classes)
...
class BasePointNet(nn.Module):
    ...
    def forward(self, x, plot=False):
        ...
        global_features = x.view(-1, 256)                      # global feature vector         [batch, 256]
